defmodule Arango.Replication do
  ...
  # """
  # @spec replication_applier_config(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_applier_config_upadte(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_applier_start(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_applier_state(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_applier_stop(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_batch_create(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_batch_delete(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_batch_prolong(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec cluster_inventory(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_dump(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_inventory(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_first_tick(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_logger_follow(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_logger_state(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_logger_tick_ranges(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_make_slave(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_server_id(Endpoint.t) :: Arango.ok_error(map)
  ...
  # """
  # @spec replication_sync(Endpoint.t) :: Arango.ok_error(map)
