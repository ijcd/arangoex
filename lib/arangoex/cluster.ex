defmodule Arangoex.Cluster do
  ...
  # """
  # @spec delete_roundtrip(Endpoint.t) :: Arangoex.ok_error(map)
  ...
  # """
  # @spec execute_roundtrip(Endpoint.t, :get | :head | :post | :put) :: Arangoex.ok_error(map)
  ...
  # """
  # @spec update_roundtrip(Endpoint.t) :: Arangoex.ok_error(map)
  ...
  # """
  # @spec check_port(Endpoint.t) :: Arangoex.ok_error(map)
